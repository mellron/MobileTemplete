...
function TextInputNumbersOnlyEvent(sDivOrClass,success_function)
{
    $(sDivOrClass).unbind('keypress');    
    $(sDivOrClass).unbind('input');    
    
    $(sDivOrClass).keypress(function (e) {
       //if the letter is not digit then display error and don't type anything or a . (46)
